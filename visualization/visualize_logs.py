...
def visualize_rope_states(save_figures=False):
    ...
    segment_positions_z = [
        col for col in rope_df.columns if "_z" in col and "segment" in col
    ]
    ...
    segment_positions_x = [
        col for col in rope_df.columns if "_x" in col and "segment" in col
    ]
    segment_positions_y = [
        col for col in rope_df.columns if "_y" in col and "segment" in col
    ]
    ...
    segment_velocities = [
        col for col in rope_df.columns if "_v" in col and "segment" in col
    ]
    ...
    plt.imshow(
        ...
        aspect="auto",
        cmap="hot",
        extent=[time.min(), time.max(), 0, len(segment_velocities)],
    )
